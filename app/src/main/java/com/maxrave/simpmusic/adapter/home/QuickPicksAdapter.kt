...
class QuickPicksAdapter(
    ...
    inner class ViewHolder(val binding: ItemQuickPicksBinding, listener: OnClickListener) :
        RecyclerView.ViewHolder(binding.root) {
        init {
            val params = binding.itemQuickContainer.layoutParams
            params.width =
                (context.resources.displayMetrics.widthPixels * 0.75).toInt()
            binding.itemQuickContainer.layoutParams = params
