...
class SearchItemAdapter(private var searchResultList: ArrayList<Any>, var context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun setDownloadedList(downloadedList: ArrayList<SongEntity>?) {
        val oldList = ArrayList(downloadedList ?: emptyList())
        this.downloadedList = oldList
...
//    fun setDownloadedList(downloadedList: ArrayList<SongEntity>?) {
//        val oldList = ArrayList(downloadedList) // Copy old list for comparison
//        this.downloadedList.clear()
//        downloadedList?.let { this.downloadedList.addAll(it) }
//        // Notify only for items that are SongsResult or SongEntity
//        searchResultList.forEachIndexed { index, result ->
//            if (result is SongsResult || result is SongEntity) {
//                val videoId = when (result) {
//                    is SongsResult -> result.videoId
//                    is SongEntity -> result.videoId
//                    else -> null
//                }
//                val wasDownloaded = oldList.any { it.videoId == videoId }
//                val isDownloaded = downloadedList?.any { it.videoId == videoId } ?: false
...
//    }
//
//    fun setNowPlaying(videoId: String?) {
//        val oldPlayingTrackVideoId = playingTrackVideoId
//        playingTrackVideoId = videoId
//        // Notify only for items that are SongsResult or SongEntity
//        searchResultList.forEachIndexed { index, result ->
//            if (result is SongsResult || result is SongEntity) {
//                val resultVideoId = when (result) {
//                    is SongsResult -> result.videoId
//                    is SongEntity -> result.videoId
//                    else -> null
//                }
//                if (resultVideoId == playingTrackVideoId || resultVideoId == oldPlayingTrackVideoId) {
//                    notifyItemChanged(index)
//                }
//            }
//        }
