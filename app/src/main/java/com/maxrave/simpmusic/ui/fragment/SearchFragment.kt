    ...
    override fun onResume() {
        ...
        binding.svSearch.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                if (query != null) {
                    AdMobInterstitialAdSearch.getInstance().showInterstitialAd(activity) {
                        search(query)
                    }
                }
                return false
...
//        LanguagePreference.setAppLanguage(requireContext(), LanguagePreference.getSelectedLanguage(requireContext()))
        ...
        binding.resultList.apply {
            layoutManager = LinearLayoutManager(context)
            AdMobInterstitialAdSearch.getInstance().init(activity)
        ...
        suggestYTItemAdapter.setOnClickListener(object : SuggestYTItemAdapter.onItemClickListener {
            override fun onItemClick(position: Int, type: String) {
                ...
                AdMobInterstitialAdSearch.getInstance().showInterstitialAd(activity,
                    AdMobInterstitialAdSearch.AdClosedListener {
                        if (type == "artist") {
                            val channelId =
                                (suggestYTItemAdapter.getCurrentList()[position] as ArtistItem).id
                            val args = Bundle()
                        ...
                        if (type == Config.ALBUM_CLICK) {
                            val browseId =
                                (suggestYTItemAdapter.getCurrentList()[position] as AlbumItem).browseId
                            val args = Bundle()
                        ...
                        if (type == Config.PLAYLIST_CLICK) {
                            val id =
                                (suggestYTItemAdapter.getCurrentList()[position] as PlaylistItem).id
                            val args = Bundle()
                        ...
                        if (type == Config.SONG_CLICK) {
                            val songClicked =
                                suggestYTItemAdapter.getCurrentList()[position] as SongItem
                            val videoId =
                                (suggestYTItemAdapter.getCurrentList()[position] as SongItem).id
                            Queue.clear()
                            ...
                            args.putString(
                                "from",
                                "\"${binding.svSearch.query}\" ${getString(R.string.in_search)}"
                            )
                        ...
                        if (type == Config.VIDEO_CLICK) {
                            val videoClicked =
                                suggestYTItemAdapter.getCurrentList()[position] as VideoItem
        ...
        resultAdapter.setOnClickListener(object : SearchItemAdapter.onItemClickListener {
            ...
            override fun onItemClick(position: Int, type: String) {
                if (type == "artist") {
                    val channelId =
                        (resultAdapter.getCurrentList()[position] as ArtistsResult).browseId
                    val args = Bundle()
                    args.putString("channelId", channelId)
                    findNavController().navigateSafe(
                        R.id.action_bottom_navigation_item_search_to_artistFragment,
                    ...
                    AdMobInterstitialAdSearch.getInstance().showInterstitialAd(activity) {
                        if (type == Config.ALBUM_CLICK) {
                            val browseId =
                                (resultAdapter.getCurrentList()[position] as AlbumsResult).browseId
                            val args = Bundle()
                            args.putString("browseId", browseId)
                            findNavController().navigateSafe(R.id.action_global_albumFragment, args)
                        }
                        if (type == Config.PLAYLIST_CLICK) {
                            ...
                            val id =
                                (resultAdapter.getCurrentList()[position] as PlaylistsResult).browseId
                        ...
                        if (type == Config.SONG_CLICK) {
                            ...
                            val videoId =
                                (resultAdapter.getCurrentList()[position] as SongsResult).videoId
                            Queue.clear()
                            val firstQueue: Track = songClicked.toTrack()
                            Queue.setNowPlaying(firstQueue)
                            val args = Bundle()
            ...
            override fun onOptionsClick(position: Int, type: String) {
                ...
                val track =
                    if (song is SongsResult) song.toTrack() else (song as VideosResult).toTrack()
