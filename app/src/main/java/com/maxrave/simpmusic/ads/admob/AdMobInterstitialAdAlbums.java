...
public class AdMobInterstitialAdAlbums {
    private static AdMobInterstitialAdAlbums mInstance;
    private InterstitialAd mInterstitialAd;
    private AdMobInterstitialAdAlbums.AdClosedListener mAdClosedListener;
    ...
    public static AdMobInterstitialAdAlbums getInstance() {
        if (mInstance == null) {
            mInstance = new AdMobInterstitialAdAlbums();
        }
        return mInstance;
    }
    ...
    private void loadInterstitialAd(Activity activity) {
        AdConfig adConfig = (AdConfig) SharedPrefsHelper.loadObjectPrefs(activity, SharedPrefsHelper.Key.Interstitial_Albums.name(), AdConfig.class);
    ...
    public void showInterstitialAd(Activity activity, AdMobInterstitialAdAlbums.AdClosedListener mAdClosedListener) {
