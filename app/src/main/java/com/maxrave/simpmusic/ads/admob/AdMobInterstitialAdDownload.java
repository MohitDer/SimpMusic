...
public class AdMobInterstitialAdDownload {

    private static AdMobInterstitialAdDownload mInstance;
    ...
    public static AdMobInterstitialAdDownload getInstance() {
        if (mInstance == null) {
            mInstance = new AdMobInterstitialAdDownload();
        }
        return mInstance;
    }
    ...
    private void loadInterstitialAd(Activity activity) {
        GoogleMobileAdsConsentManager googleMobileAdsConsentManager = GoogleMobileAdsConsentManager.Companion.getInstance(activity);
        AdConfig adConfig = (AdConfig) SharedPrefsHelper.loadObjectPrefs(activity, SharedPrefsHelper.Key.Interstitial_Download_Click.name(), AdConfig.class);
