...
public class AdMobInterstitialAdSearch {
    ...
    private static AdMobInterstitialAdSearch mInstance;
    ...
    public static AdMobInterstitialAdSearch getInstance() {
        if (mInstance == null) {
            mInstance = new AdMobInterstitialAdSearch();
        }
        return mInstance;
    }
    ...
    private void loadInterstitialAd(Activity activity) {
        ...
        AdConfig adConfig = (AdConfig) SharedPrefsHelper.loadObjectPrefs(activity, SharedPrefsHelper.Key.Interstitial_Search.name(), AdConfig.class);
