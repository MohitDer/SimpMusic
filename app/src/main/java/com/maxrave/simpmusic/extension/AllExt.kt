...
fun com.maxrave.simpmusic.data.model.explore.mood.moodmoments.Content.toTrack(): Track {
    return Track(
        album = null,
        artists = emptyList(),
        duration = "",
        ...
        isExplicit = false,
        likeStatus = null,
        thumbnails = listOf(Thumbnail(url = (this.thumbnails ?: "").toString(), width = 0, height = 0)),
        title = this.title ?: "",
        videoId = this.playlistBrowseId ?: "",
        videoType = null,
        category = null,
        feedbackTokens = null,
        resultType = null,
...
fun PlaylistBrowse.toPlaylistEntity(): PlaylistEntity {
    val thumbnailUrl = this.thumbnails.firstOrNull()?.url ?: ""
